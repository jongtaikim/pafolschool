...
/**
* 파일명: lib/class.IniFile.php 
* 작성일: 2003-01-28
* 작성자: 거친마루
* 설  명: ini 파일 형식의 설정 다루기
*****************************************************************
* 2005-05-10 설정파일 보안 형태바꿈
*/
...
class IniFile {
	...
	function setVar($key,$value=".",$section="") {
        ...
        if (!ereg("^[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*$", $value)) $this->iniArray[$section][$key]['quote'] = true;
