...
$sdate=mktime($i,0,0,$month,1,$year);
$edate=mktime($i,59,59,$month,31,$year);


 $sql = "select str_re_name, count(str_ip) as counter from TAB_IP_COUNTER where num_date >= '$sdate' and num_date <= '$edate'  group by str_re_name order by counter desc";
