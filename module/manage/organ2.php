...
$tpl->setLayout('admin');
$tpl->define("CONTENT", Display::getTemplate("manage/organ2.htm"));
...
$tpl->assign(array(
	...
	case "POST":
		 ...
		 $sql = "UPDATE ".TAB_ORGAN." SET str_memo='$str_memo',str_gi_id='$str_gi_id',str_gi_pw='$str_gi_pw',str_arba='$str_arba'
		 ,str_pro1='$str_pro1' 
		 ,str_pro2='$str_pro2'
		 ,str_pro3='$str_pro3'
		 ,str_pro4='$str_pro4'
