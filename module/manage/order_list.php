...
switch ($REQUEST_METHOD) {
	case "GET":
		...
		if($whereadd2) {
			...
			//2008-03-25 종태 .. 이유는 묻지마..
			$sql = "select str_host from tab_organ where str_num_step = '$num_s' ";
			$row[0][host_ff] = $DB -> sqlFetchOne($sql);
		...
		$tpl->setLayout();
		$tpl->define("CONTENT", "module/manage/order_list_setup.htm");	
