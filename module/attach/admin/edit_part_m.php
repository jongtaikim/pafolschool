...
switch($REQUEST_METHOD) {
	case "GET":
        ...
        $sql = "SELECT num_serial,str_title, str_title,str_text1,str_text2,str_text3 FROM ".TAB_ATTACH_PART." WHERE num_oid=$_OID AND num_serial='$id' and num_css='"._CSS."'";
        $data = $DB->sqlFetch($sql);
		

		$msg = $data[str_text1].$data[str_text2].$data[str_text3];// 파일지정하고
	...
	case "POST":
        ...
        $FTP->put_string($msg,_DOC_ROOT.'/hosts/'.HOST.'/'.$attach_file);
