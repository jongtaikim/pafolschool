...
switch ($REQUEST_METHOD) {
	case "GET":
		...
		$tpl->setLayout('admin');
		$tpl->define('CONTENT', WebApp::getTemplate('doc_board/admin/manage/basic.htm'));
		...
		break;
	case "POST":
        $data = Form::values('str_title','num_listnum','num_navnum','num_titlelen','chr_oddcolor','chr_evencolor');
        ...
        $sql = "
            UPDATE $CONFIG_TABLE SET
                ...
                chr_recent='$chr_recent', chr_comment='$chr_comment',num_board_point = '$num_board_point' , num_repaly_point = '$num_repaly_point', num_commint_point='$num_commint_point'
            WHERE
