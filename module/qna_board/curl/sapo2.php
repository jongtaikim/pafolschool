...
//////////////////////////////////////////////////////////////////////////////////////////////
$curl->url="http://www.sapo.es.kr/c_bbs/view.html?t_list=".$bbs_id."&id=".$ii;


$res = $curl->curl_login();

$res = explode("<!-- <tr><td width='560' height='3' bgcolor=''></td></tr>	-->",$res);
$res = explode("<!-- <tr><td height='3' bgcolor='FFFFFF'></td></tr>",$res[1]);
$res = $res[0];



$subject = explode("<td width='488' align='left'><b>",$res);
$subject = explode("</b>",$subject[1]);
$subject = $subject[0];	

if($subject){

$date = explode("<td width='185' align='left'>2",$res);
...
$name = explode("<td width='185' align='left'>",$res);
$name = explode('</td>',$name[1]);
$name = strip_tags($name[0]);	

$content = explode('<td align=left>',$res);
$content = explode('</td>',$content[1]);
$content = $content[0];	
$content = str_replace("'","`",$content );
$content = str_replace("&nbsp;"," ",$content );

$file1 = explode("<img src='./upload/",$res);
$file1 = explode("'",$file1[1]);
$file1 = $file1[0];	
//$file1_name = explode("<img src='./upload/",$res);
...
$file1_name = $file1;
	...
	if($file1) {
				...
				$url = "http://www.sapo.es.kr/c_bbs/upload/".$file1_name;
				$ch = curl_init($url);
...
$file2 = explode("<a href='d",$res);
$file2 = explode("'",$file2[2]);
$file2 = $file2[0];	
$file2_name = explode("byte)'>",$res);
$file2_name = explode("</a>",$file2_name[2]);	
$file2_name = $file2_name[0];
	...
	if($file2) {
				...
				$url = "http://www.sapo.es.kr/c_bbs/upload/".$file2_name;
				$ch = curl_init($url);
...
echo $subject." /".$date." / ".$hit."/".$name."<TEXTAREA >".$content."</TEXTAREA>".$file1_name.$file2_name .$url."<br>";
