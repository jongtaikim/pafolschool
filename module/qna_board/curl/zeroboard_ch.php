...
//////////////////////////////////////////////////////////////////////////////////////////////
$curl->url="http://chipyong.ms.kr/zboard/view.php?id=".$bbs_id."&no=".$ii;


$res = $curl->curl_login();

$res = explode("<td align=right valign=bottom>",$res);
$res = explode('<!--"<--></table>',$res[1]);
$res = $res[0];



$subject = explode("<td>&nbsp;<font class=yeinfont>",$res);
$subject = explode("</td>",$subject[2]);
$subject = $subject[0];	

if($subject){

$date = explode("class=zv3_small>(",$res);
$date = explode(' ',$date[1]);
$date = $date[0];	
$date = date("Y-m-d");	
...
$file1 = $file1[0];	
	...
	if($file1) {
				...
				$url = "http://chipyong.ms.kr/zboard/data/".$bbs_id."/".$file1;
				$ch = curl_init($url);
				$mk = mktime();
...
if($file2) {
				...
				///////////////////////////////////////////
				$url2 = "http://chipyong.ms.kr/zboard/data/".$bbs_id."/".$file2;
				$ch = curl_init($url2);
