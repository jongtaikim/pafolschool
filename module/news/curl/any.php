...
$curl->cookie="&COBEE_AUTH=Tcd2cf4";
$curl->url="http://www.anyangseo.ms.kr/notice.brd?_1";

$res = $curl->curl_login();
echo $res;
exit;
$res = explode('<table border=0 width=600 cellpadding=0 cellspacing=0>',$res);
$res = explode('<table border="0" cellpadding="0" cellspacing="1" style="border-collapse: collapse" width="100%" id="AutoNumber1">',$res[1]);
$res = $res[0];



$subject = explode('<td bgcolor="#FFFFFF" colspan="3"><b>',$res);
$subject = explode("</b></td>",$subject[1]);
$subject = $subject[0];	

if($subject){

$date = explode('<td bgcolor="#FFFFFF" height="12" width=400>',$res);
$date = explode('&nbsp;',$date[1]);
$date = explode('/',$date[0]);
...
$hit = explode('<td bgcolor="#FFFFFF" align="center" width=100>',$res);
$hit = explode('</td>',$hit[2]);
$hit = $hit[0];	

$content = explode('<hr size=0>',$res);
$content = explode('<hr color="#666666" style="border-style: dotted; border-width: 1" noshade size="1">',$content[1]);
$content = $content[0];	
$content = str_replace("'","`",$content );

$file1 = explode('<td width="84%"><a href="',$res);
$file1 = explode('">',$file1[1]);
$file1 = $file1[0];	


$file1_name = explode('<td width="84%"><a href="',$res);

$file1_name = explode('">',$file1_name);
...
$file1_name = $file1_name[0];
	...
	if($file1) {
				...
				$url = "http://www.anyangseo.ms.kr".$file1;
				$ch = curl_init($url);
...
$file2 = $file2[0];	
$file2_name = explode('align="absmiddle">',$file2);
