...
$curl->url="http://kumok.ms.kr/?act=news.main&comm=".$code."&sid=".$ii;

$res = $curl->curl_login();

$res = explode('<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">',$res);
$res = explode('<tr><td >&nbsp;</td></tr>',$res[1]);
$res = $res[0];
...
$file1 = $file1[0];	
$file1_name = explode('align="absmiddle">',$file1);
