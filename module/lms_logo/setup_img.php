...
<TR>
	...
	<TD><input type="file" name="upfile1" style="width:312;"  class=button onchange = "submit();"></TD>
	<TD><INPUT TYPE="submit" value = "올리기" class=button></TD>
</TR>
</TABLE>
...
echo "<script>
parent.insss('http://".$FH->host."/hosts/".HOST."/menu/board_img/".$file->SaveName."');	
parent.ImageDialog.showPreviewImage('http://".$FH->host."/hosts/".HOST."/menu/board_img/".$file->SaveName."');
history.go(-1);
</script>";
