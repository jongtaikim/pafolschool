...
$res = explode("  <td class=salz_general1 align=right height=30 valign=bottom>",$res);
$res = explode("<!-- 간단한 답글 시작하는 부분 -->",$res[1]);
$res = $res[0];



$subject = explode(" <td style='word-break:break-all;'>",$res);
...
$file1 = explode("<td class=salz_general1><a href='",$res);
$file1 = explode("'>",$file1[1]);
$file1 = $file1[0];	

$file1_name = explode("<td class=salz_general1><a href='",$res);
...
$file1_name = $file1_name[0];
	...
	if($file1) {
				...
				GDImageResize($tmp_file, $tmp_file."_100", 100, 78);
