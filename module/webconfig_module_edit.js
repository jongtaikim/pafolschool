	...
	tinyMCE.init({
		...
		theme_advanced_buttons1 : "code,pasteword,cleanup,image,|,justifyleft,justifycenter,justifyright,justifyfull,|,fontselect,fontsizeselect,|,bold,italic,underline,strikethrough,forecolor,backcolor,|,table,|,link,unlink,",
