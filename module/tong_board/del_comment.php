...
$DB = &WebApp::singleton('DB');
	...
	$sql = "select str_user, TO_CHAR(dt_date,'YYYYMMDD') dt_date from $COMMENT_TABLE where num_oid = $_OID and num_mcode = $mcode and num_main=$main AND num_serial=$id ";
...
if ($pass) {
	...
	$data = $DB->sqlFetch("SELECT str_pass, str_user, TO_CHAR(dt_date,'YYYYMMDD') dt_date FROM $COMMENT_TABLE WHERE $que num_mcode=$mcode AND num_main=$main AND num_serial=$id");
