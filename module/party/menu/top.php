...
$sql = "SELECT /*+ INDEX(".TAB_PARTY_MENU." ".IDX_TAB_PARTY_MENU_INDEX.") */ * FROM ".TAB_PARTY_MENU." ".
		"WHERE num_oid="._OID."  and num_pcode = ".$_pcode."AND LENGTH(num_mcode)=2 AND num_view=1 and str_top_menu = 'Y'  $que  ORDER BY num_step";
...
$tpl->define("SUBMENU_AREA__",$template);
$tpl->assign(array(
...
$content = $tpl->fetch("SUBMENU_AREA__");
