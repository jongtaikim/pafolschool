<?php
	...
	$LGD_MERTKEY = "d57e7f13d1679b1cd2eebba00d8f7e8b";  //LG유플러스에서 발급한 상점키로 변경해 주시기 바랍니다.
        ...
        if ( "0000" == $LGD_RESPCODE ){ //결제가 성공이면
        	if( "R" == $LGD_CASFLAG ) {
			 ...
			 if($LGD_OID){
				...
				$DB->updateQuery("TAB_ORDER",$datas," num_oid = '$_OID'  and str_order_code = '".$LGD_OID."'");
			 }
            	$resultMSG = "OK";
