...
<div class="box-inside">
    ...
    <div class="login-cash"><a href="http://point.miwit.com/plugin/cybercash/"><strong><?=$mw_cash[cf_cash_name]?></strong>: <span class="login-cash-number"><?=number_format($mw_cash[mb_cash])?></span> <?=$mw_cash[cf_cash_unit]?></a></div>
