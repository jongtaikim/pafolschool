...
<caption align=left><a href="<?=$g4[path]?>"><img src="<?=$mw_member_skin_head_path?>/img/mw_logo.gif"></a></caption>
<tr>
    <td width="628" height=10></td>
</tr>
<tr> 
    <td width="628" height=2 bgcolor="#8F8F8F"></td>
</tr>
<tr> 
    <td width="628" height=48 align="right" background="<?=$member_skin_path?>/img/modify_table_bg_top.gif"><img src="<?=$member_skin_path?>/img/modify_img.gif" width="344" height="48"></td>
</tr>
<tr> 
    <td width="628" height=223 align="center" background="<?=$member_skin_path?>/img/modify_table_bg.gif">
...
<tr> 
    <td width="628" height=1 bgcolor="#F0F0F0"></td>
</tr>
</table>
