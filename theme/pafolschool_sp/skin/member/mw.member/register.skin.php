...
<table border=0 width=600 cellspacing=0 cellspacing=0 align=center style="margin:10px auto 0 auto;">
<tr>
    <td><a href="<?=$g4[path]?>"><img src="<?=$mw_member_skin_head_path?>/img/mw_logo.gif"></a></td>
</tr>
<tr><td align=center>
    ...
    <table width="100%" cellpadding="4" cellspacing="0" bgcolor=#EEEEEE>
        ...
        <tr> 
            <td align="center" valign="top"><textarea style="width:98%; background-color:#fff; font-size:12px;" rows=5 readonly class=ed><?=get_text($config[cf_stipulation])?></textarea></td>
        </tr>
        <tr> 
    ...
    <table width="100%" cellpadding="4" cellspacing="0" bgcolor=#EEEEEE>
        ...
        <tr> 
            <td align="center" valign="top"><textarea style="width:98%; background-color:#fff; font-size:12px;" rows=5 readonly class=ed><?=get_text($config[cf_privacy])?></textarea></td>
        </tr>
        <tr> 
