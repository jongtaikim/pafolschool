...
<table width="668" border="0" cellspacing="0" cellpadding="0" align=center style="margin:10px auto 0 auto;">
    <tr>
	<td colspan="3"><a href="<?=$g4[path]?>"><img src="<?=$mw_member_skin_head_path?>/img/mw_logo.gif"></a></td>
    </tr>
    <tr> 
